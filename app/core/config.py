...
class Settings(BaseSettings):
    ...
    FRONTEND_URI: str = os.getenv("FRONTEND_URI", "http://127.0.0.1:5173/dashboard")
    ...
    ALLOWED_FINAL_REDIRECT_URIS_STR: str = os.getenv("ALLOWED_FINAL_REDIRECT_URIS", "http://127.0.0.1:5173/dashboard")
    ALLOWED_FINAL_REDIRECT_URIS: List[str] = [uri.strip() for uri in ALLOWED_FINAL_REDIRECT_URIS_STR.split(',')]
    
    DEFAULT_FINAL_REDIRECT_URI: str = os.getenv("DEFAULT_FINAL_REDIRECT_URI")
